<section class="parallax-window parallax-window--trading-demo" data-image-src="dist/images/bg-trading-01.jpg">
  <div class="container">
    <div class="row">
      <div class="col-md-9">
      ...
      <div class="col-md-3">
        <ol class="breadcrumb">
          ...
          <li class="active">Demo Account</li>
        </ol>
      </div>
    </div>
  </div>
    ...
    <div class="row">
      ...
      <div class="col-md-5 col-md-offset-1">
        <ul class="checklist mbm">
          <?php
            $detail = myExplode(translate($this, $themeOptions['detail_demo_account']));
            foreach ($detail as $val){
              echo '<li><i class="glyphicon glyphicon-ok-circle"></i>'.$val.'</li>';
            }
          ?>
        </ul>
        <?php echo translate($this, $themeOptions['info_demo_account']);?>
      </div>
    </div>
  </div>
</section>