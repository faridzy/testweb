        ...
        <form id="new-product" class="form-horizontal" method="get" action="#" role="form">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10 col-md-8">
                    <div class="well">
                        <div class="pic">
                            <img alt="Product" class="img-responsive" src="image/product-0c733a76a7235e3efb1c5767c3a1cd76.jpg" />
                        </div>
            ...
            <div class="form-group form-actions">
                <div class="col-sm-offset-2 col-sm-10 col-md-offset-2 col-md-10">
                    <a href="/1.1/forms/new_product" class="btn btn-default">Cancel</a>
